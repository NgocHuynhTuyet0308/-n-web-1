					...
					<div class="col-lg-12 login-form">
						<form action="" method="post">
							<div class="form-group">
								...
								<input type="text" class="form-control" name="un" onkeyup="daoNutDN()" id="un" autofocus
									autocomplete="off">
							</div>
							<div class="form-group">
								<label class="form-control-label">MẬT KHẨU</label>
								<input type="password" class="form-control" name="mk" onkeyup="daoNutDN()" id="mk">
								<i class="fa fa-eye text-secondary " onclick="daoTT()"></i>
							</div>
							...
							<div class="col-lg-12 loginbttm">
								...
								<div class="col-lg-12 login-btm login-button text-center">
									<button type="submit" class="btn btn-outline-primary" id="btndangnhap"
										name="btndangnhap" onclick="return validate()">Đăng
										nhập</button>
								</div>
							</div>
						</form>
		...
		<script>
			...
			function validate() {
				...
				if (username == "admin" && password == "admin123") {
					...
					attempt = 3;// Decrementing by one.
					alert("Bạn còn" + attempt + "lần thử!");
