...
<body>
        ...
        <div class="header__content container-xl ">
            ...
            <nav class="header__menu">
                <ul class="menu menu-1" id="mainNav">
                    ...
                    <li class="active"><a href="../pages/intro.html">GIỚI THIỆU</a></li>
    ...
    <!-- UPDATING -->
    <section class="updating container">
        <div class="w-100 updating__content">
            <div><i class="fas fa-tools"></i>
                <h3>Hệ thống đang cập nhật</h3>
                <h4>Vui lòng quay lại sau!</h4>
                <button class="btn"> <a href="../index.html">Quay về trang chủ</a></button>
            </div>
        </div>
    </section>
    <!-- FOOTER  -->
