	...
	<div class="login">
		<form action="" class="seou--login">
			<div class="container--Login">
				...
				<div class="signup-link">Bạn mới biết đến SEOUL? <a href="SignUp.html">Đăng ký ngay</a></div>
			</div>
		</form>
	</div>
		...
		<div class="modal_inner">
			...
			<div class="modal_footer">
				<button class="btn_success">
					<a href="../page_user/user-index.html">Bắt đầu khám phá thôi</a>
				</button>
			</div>
		</div>
	</div>
		...
		<div class="modal_innerfail">
			...
			<div class="modal_footerfail">
				<button class="btnfail">
					<a href="./Login.html">Mời bạn đăng nhập lại</a>
				</button>
			</div>
		</div>
	</div>
