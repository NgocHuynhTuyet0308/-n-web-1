...
<body>
		...
		<div class="header__content container-xl ">
			...
			<nav class="header__menu">
				<ul class="menu menu-1" id="mainNav">
					...
					<li class=""><a href="../pages/Menu/all-menu.html">THỰC ĐƠN</a></li>
	...
	<form action="" onload="" class="forgotpassword">
		<div class="container">
			...
			<div class="form-control">
				<input type="email" id="email" placeholder="Email cá nhân" />
				<span></span>
				<small></small>
			</div>
			<div class="form-control">
			...
			<div class="signup-link">Bạn đã có tài khoản? <a href="./Login.html">Đăng nhập ngay</a></div>
		</div>
	</form>
		...
		<div class="modal_inner">
			...
			<div class="modal_footer">
				<button class="btn_success">
					<a href="./Login.html">Đăng nhập ngay nào</a>
				</button>
			</div>
		</div>
	</div>
	...
	<script src="../js/appForgotPassword.js"></script>
</body>
